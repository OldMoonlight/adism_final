...
class UberGallery {
     ...
     *
     * @param int $width Thumbnail width in pixels (default = 270)
     * @param int $height Thumbnail height in pixels (default = 170)
     * @return object Self
     * @access public
     */
    public function setThumbSize($width = 270, $height = 170) {
     ...
     * Set theme name
     *
     * @param string $name Theme name (default = fass-custom)
     * @return object Self
     * @access public
     */
    public function setThemeName($name = 'fass-custom') {
